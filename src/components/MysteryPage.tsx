  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black pt-24 pb-12">
      ...
      <div className="absolute inset-0 overflow-hidden opacity-5">
        <motion.div
          className="absolute top-20 left-10 w-48 h-48 border-4 border-red-600 rounded-full"
          animate={{ rotate: 360 }}
          transition={{ duration: 40, repeat: Infinity, ease: "linear" }}
          style={{
            background: `conic-gradient(from 0deg, transparent, #E84142, transparent)`,
            clipPath: 'polygon(50% 0%, 60% 35%, 100% 35%, 70% 57%, 85% 100%, 50% 75%, 15% 100%, 30% 57%, 0% 35%, 40% 35%)'
          }}
        />
        <motion.div
          className="absolute bottom-20 right-10 w-40 h-40 border-3 border-white rounded-full"
          animate={{ rotate: -360 }}
      ...
      <div className="container mx-auto px-6">
        ...
        >
          <h1 className="text-5xl mb-6 text-white" style={{ 
            fontFamily: 'serif',
        ...
        >
            ...
            {connections.map((connection, index) => {
              ...
              return (
                <motion.line
                  ...
                  style={{
                    filter: 'drop-shadow(0 0 5px #E84142)'
                  }}
                />
              );
            })}
          ...
          {mysteryNotes.map((note, index) => (
            ...
            >
              <div className={`relative w-32 h-32 bg-black border-3 ${
                ...
                } to-transparent rounded-lg opacity-0 hover:opacity-100 transition-opacity duration-300`}></div>
              </div>
            </motion.div>
          ))}
          ...
          >
            <div className="relative w-20 h-20">
              ...
              />
              <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-xs text-red-600" style={{ 
                fontFamily: 'serif',
                textShadow: '0 0 10px #E84142'
              }}>
                ?
              </div>
            </div>
        ...
        >
          <div className="inline-flex items-center space-x-4 bg-black border-2 border-red-600 rounded-lg px-6 py-3">
            <span className="text-white" style={{ fontFamily: 'serif' }}>Mystery Progress:</span>
